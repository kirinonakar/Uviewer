            ...
            private static class WebDavFeatureComposition
            {
                public static void Initialize(MainWindow window)
                {
                    window._webDavDocumentOpenCoordinator = new WebDavDocumentOpenCoordinator(new WebDavDocumentOpenHandlers
                    {
                        ...
                        CreateDownloadFailedStatus = () => Strings.WebDavDownloadFailed,
                        CreateFileOpenFailedStatus = ex => Strings.FileOpenFailed(ex.Message),
                        CreateArchiveOpenFailedStatus = ex => Strings.ArchiveOpenFailed(ex.Message),
