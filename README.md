...
- **HDR Viewing (optional)**: HDR-capable display with HDR enabled under **Windows Settings → System → Display → HDR**. HDR AVIF decoding uses the bundled libavif runtime.
